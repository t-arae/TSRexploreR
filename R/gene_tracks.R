...
gene_tracks <- function(
  ...
  feature_ranges <- switch(ftype,
    "transcript_promoter"=GenomicFeatures::promoters(GenomicFeatures::transcripts(anno), upstream=upstream, downstream=downstream),
    "gene_promoter"=GenomicFeatures::promoters(GenomicFeatures::genes(anno), upstream=upstream, downstream=downstream),
